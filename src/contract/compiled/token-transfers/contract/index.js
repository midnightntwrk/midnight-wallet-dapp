...
class _Either_0 {
  alignment() {
    return _descriptor_5.alignment().concat(_descriptor_4.alignment().concat(_descriptor_9.alignment()));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_5.toValue(value_0.is_left).concat(_descriptor_4.toValue(value_0.left).concat(_descriptor_9.toValue(value_0.right)));
  }
}
...
class _CoinPreimage_0 {
  alignment() {
    return _descriptor_13.alignment().concat(_descriptor_6.alignment().concat(_descriptor_5.alignment().concat(_descriptor_0.alignment())));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_13.toValue(value_0.domain_sep).concat(_descriptor_6.toValue(value_0.info).concat(_descriptor_5.toValue(value_0.dataType).concat(_descriptor_0.toValue(value_0.data))));
  }
}
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      sendShieldedToUser: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_3.toValue(input_0).concat(_descriptor_4.toValue(publicKey_0).concat(_descriptor_1.toValue(value_0))),
  ...
  _receiveShielded_0(context, partialProofData, coin_0) {
    const recipient_0 = this._right_1(_descriptor_9.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                partialProofData,
                                                                                                [
                                                                                                 { dup: { n: 2 } },
                                                                                                 { idx: { cached: true,
  ...
  _mintAndReceive_0(context, partialProofData, amount_0) {
    ...
    const color_0 = this._mintUnshieldedToken_0(context,
                                                ...
                                                domain_0,
                                                amount_0,
                                                this._left_0(_descriptor_9.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                                       partialProofData,
                                                                                                                       [
                                                                                                                        { dup: { n: 2 } },
                                                                                                                        { idx: { cached: true,
  ...
  _mintShieldedToSelf_0(context, partialProofData, domainSep_0, value_0, nonce_0)
  {
    return this._mintShieldedToken_0(context,
                                     ...
                                     value_0,
                                     nonce_0,
                                     this._right_1(_descriptor_9.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                             partialProofData,
                                                                                                             [
                                                                                                              { dup: { n: 2 } },
                                                                                                              { idx: { cached: true,
